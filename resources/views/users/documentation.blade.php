	...
	<br><br>
		...
		<div class="table-responsive">
            <table class="table table-documentation">
                ...
                <td>
                    @if ($userdoc->d_link)
                        <a id="link-table" href="{{ $userdoc->d_link }}" target="_blank">{{ Str::limit($userdoc->d_link, 20) }}{{ strlen($userdoc->d_link) > 20 ? : '' }}</a>
                    @else
                        No link available
                    @endif
                </td>
...
<!-- Edit Modal -->
<div class="modal fade edit-modal" id="editDocumentationModal{{ $userdoc->d_id }}" tabindex="-1" aria-labelledby="editDocumentationModalLabel{{ $userdoc->d_id }}" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
